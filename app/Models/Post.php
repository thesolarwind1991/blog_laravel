...
class Post extends Model
{
    ...
    protected $perPage = 5;
    /*
     * Аттрибуты, которые должны быть преобразованы в дату
     */
    ...
    // Связь модели Post с моделью Comment, позволяет получить все
    // комментарии поста
    ...
    /*
     * Возвращает правду, если пользователь является автором
     */
