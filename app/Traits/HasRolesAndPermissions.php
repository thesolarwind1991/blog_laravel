...
trait HasRolesAndPermissions {
    ...
    /*
     * Имеет ли текущий пользователь право $permission либо напрямую,
    ...
    /*
     * Имеет ли текущий пользователь все права из $permissions либо
    ...
    /*
     * Имеет ли текущий пользователь любое право из $permissions, либо
     * напрямую, либо через одну из своих ролей?
     */
    ...
    /*
     * Возвращает массив всех прав текущего пользователя,
     * которые к него есть через его роли
     */
    ...
    public function getAllPermsAnyWay() {
        $perms = array_merge($this->getAllPerms(),
     ...
     * (в дополнении к тем, что уже были назначены)
     */
